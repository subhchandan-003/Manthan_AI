        ...
        <div className="flex flex-col gap-6">
          <Card aiGenerated>
            ...
            <div className="flex flex-col gap-2.5 text-xs">
              <div className="self-end rounded-md rounded-tr-none bg-bg-tertiary px-3.5 py-2.5 text-text-primary">
                What&apos;s the current status of Boiler Feed Pump-A?
              </div>
              <div className="self-start rounded-md rounded-tl-none border-l-2 border-l-accent-cyan bg-bg-primary px-3.5 py-2.5 text-text-primary">
            ...
            <form onSubmit={submitQuickQuestion} className="mt-4 flex items-center gap-2 rounded-md border border-border-subtle bg-bg-primary px-3 py-2.5 focus-within:border-border-active">
              <input
                value={quickQuestion}
